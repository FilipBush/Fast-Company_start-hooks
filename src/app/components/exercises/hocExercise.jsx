        ...
        <>
            <CollapseWrapper title="Упражнение">
                ...
                <ul>
                    ...
                    <li>
                        Отображает кнопку &quot;Войти&quot;, если пользователь
                        НЕ авторизован (зависит от параметра <code>isAuth</code>{" "}
                        в <code>props</code>)
                    </li>
                    <li>
                ...
                <p className="mt-3">
                    ...
                    <code>withFunctions</code>, который будет принимать
                    компонент <code>SimpleComponent</code> и делать следующее:
                </p>
                <ul>
                    <li>
                    ...
                    <li>
                        ...
                        проверки наличия данных в <code>localStorage</code> по
                        ключу <code>auth</code>. На текущий момент нам не важно,
                        какие данные там хранить (например можно проверять
                        наличие строки <code>&quot;token&quot;</code>)
                    </li>
                    <li>
                        ...
                        <code>localStorage</code> с любым значением (например
                        строку <code>&quot;token&quot;</code>) <br />
